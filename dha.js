...
petik = '```'
fake = 'CREATOR BOT\©Ndyie Botz'//GANTI NAMA KAMU BEP
ban =[]
	...
	try {
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/ganteng.jpg`)},"title": `HALLO...${pushname}JANGAN LUPA DI ORDER`,"description": "Ndyie Botz KANG TOLOL", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Sherlynn-Botz","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`©Han\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `Hai kak.....\n*${pushname}*\nJangan Lupa Subscribe Ndyie Botz Yahh`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI LORD ©Ndyie Botz\`\`\`')
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©Ndyie Botz* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
"orderMessage": {
"orderId": "150453297177375",
"thumbnail": "",
"itemCount": 2021,
"status": "INQUIRY",
"surface": "CATALOG",
"orderTitle": "LOL",
